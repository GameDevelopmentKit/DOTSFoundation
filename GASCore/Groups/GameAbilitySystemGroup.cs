namespace GASCore.Groups
{
    ...
    public class AbilityPresentEntityCommandBufferSystem : EntityCommandBufferSystem
    {
        ...
        public unsafe struct Singleton : IComponentData, IECBSingleton
        {
            ...
            public EntityCommandBuffer CreateCommandBuffer(WorldUnmanaged world) { return EntityCommandBufferSystem.CreateCommandBuffer(ref *pendingBuffers, allocator, world); }
            /// <summary>
            ...
            public void SetPendingBufferList(ref UnsafeList<EntityCommandBuffer> buffers) { pendingBuffers = (UnsafeList<EntityCommandBuffer>*)UnsafeUtility.AddressOf(ref buffers); }
            /// <summary>
